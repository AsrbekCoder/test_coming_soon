        ...
        el.empty()
          .append(
            "<div><span class='ts-cc-number'>" +
              ...
              " </span><span class='ts-cc-description'>Kun</span></div>"
          )
          .append(
            "<div><span class='ts-cc-number'>" +
              this.leadingZeros(data.hours, 2) +
              " </span><span class='ts-cc-description'>Soat</span></div>"
          )
          .append(
            "<div><span class='ts-cc-number'>" +
              this.leadingZeros(data.min, 2) +
              " </span><span class='ts-cc-description'>Daqiqa</span></div>"
          )
          .append(
            "<div><span class='ts-cc-number'>" +
              this.leadingZeros(data.sec, 2) +
              " </span><span class='ts-cc-description'>Sekund</span></div>"
          );
      },
    });
  });
